"""
CS50 pset6 bleep
A program to censor words inputted by the user if the word is in a given dictionary.
Example:
Input:  What the heck
Output: What the ****
Link to info page: https://docs.cs50.net/2019/x/psets/6/bleep/bleep.html
